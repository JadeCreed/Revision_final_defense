...
const AuthBox = () => {
  ...
  return (
    <div className="authbox-root">
      {/* LOGO */}
      <div className="authbox-logo-wrap">
        <img src={logo} alt="AGRICE Logo" className="authbox-logo" />
      </div>

      <h2 className="authbox-title">Welcome Back!</h2>
      <p className="authbox-subtitle">
        Sign in to continue to <strong>AGRICE</strong>
      </p>
      ...
      <div className="authbox-divider" />

      {/* HELP */}
      <p className="authbox-help">
        Need assistance registering?<br />
        <Link to="#" className="authbox-help-link">Visit the Municipal Agriculture Office.</Link>
      </p>

      {/* FOOTER */}
      <p className="authbox-footer">
        AGRICE – Municipal Agriculture Office, Lucban<br />© 2025 All rights reserved.
      </p>

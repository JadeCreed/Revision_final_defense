          ...
          <div className="authbox-field">
            ...
            <div style={tabsContainerStyle}>
              <button
                ...
                style={loginType === 'email' ? activeTabStyle : inactiveTabStyle}
                onMouseEnter={e => { if (loginType !== 'email') e.currentTarget.style.color = '#4b5563'; }}
                onMouseLeave={e => { if (loginType !== 'email') e.currentTarget.style.color = '#9ca3af'; }}
              >
                Email
              </button>
              <button
                ...
                style={loginType === 'contact' ? activeTabStyle : inactiveTabStyle}
                onMouseEnter={e => { if (loginType !== 'contact') e.currentTarget.style.color = '#4b5563'; }}
                onMouseLeave={e => { if (loginType !== 'contact') e.currentTarget.style.color = '#9ca3af'; }}
              >
                Contact Number
              </button>
            </div>
            ...
            <label className="authbox-label">
              {loginType === 'email' ? 'Email' : 'Contact Number'}
            </label>
            <div className="authbox-input-wrap">
              ...
              <input
                ...
                inputMode={loginType === 'contact' ? 'numeric' : 'email'}

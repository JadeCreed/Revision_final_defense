...
const BPDashboard = () => (
  <div>
    <h1 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '0.5rem' }}>Barangay President Dashboard</h1>
    <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>View and manage your barangay's farmer records.</p>
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
      {['Barangay Farmers', 'Crop Phase', 'Announcements', 'Reports'].map(label => (

  ...
  return (
    <div style={{ flex: 1, minWidth: 0, backgroundColor: 'white', borderRadius: '1rem', padding: '1.5rem', border: '2px solid #e5e7eb', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        {[
          { key: 'number_of_bags', label: 'Number of Bags (20kg/bag)', type: 'number', placeholder: 'e.g. 1', required: true },
  ...
  return (
    <div style={{ flex: 1, minWidth: 0, backgroundColor: 'white', borderRadius: '1rem', padding: '1.5rem', border: '2px solid #bfdbfe', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        <input type="number" min="1" value={form.qty_bags || ''} onChange={e => { setForm(p => ({ ...p, qty_bags: e.target.value })); setErrors(p => ({ ...p, qty_bags: '' })); }} placeholder="Number of seed bags received" style={inp(!!errors.qty_bags)} />
        {errors.qty_bags && <p style={{ fontSize: '0.72rem', color: '#dc2626', margin: '0.25rem 0 0' }}>{errors.qty_bags}</p>}
      </div>

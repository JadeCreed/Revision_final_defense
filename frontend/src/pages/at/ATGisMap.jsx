          ...
          <div style={{ display: 'grid', gridTemplateColumns: activeTab === 'monitoring' ? 'repeat(2,1fr)' : 'repeat(3,1fr)', gap: '0.6rem' }}>
            {activeTab === 'monitoring' ? (
              <>
                ...
                <div style={{ backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: '0.75rem', padding: '0.6rem 0.75rem', textAlign: 'center' }}>
                  <p style={{ margin: 0, fontSize: '0.95rem', fontWeight: 800, color: 'white' }}>{seedBreakdown[monitoringTab]?.total || 0}</p>
                  <p style={{ margin: '0.2rem 0 0', fontSize: '0.6rem', color: 'rgba(255,255,255,0.65)', textTransform: 'uppercase', fontWeight: 700 }}>Monitored</p>
                </div>
              </>
            ) : (
              <>

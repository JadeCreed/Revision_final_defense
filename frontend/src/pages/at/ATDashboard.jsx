...
const ATDashboard = () => (
  <div>
    <h1 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '0.5rem' }}>Agricultural Technician Dashboard</h1>
    <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>Manage crop monitoring and barangay reports.</p>
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
      {['Crop Monitoring', 'Assigned Farmers', 'GIS Map', 'Reports'].map(label => (
